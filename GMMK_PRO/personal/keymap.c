...
//      Ct_L     Win_L    Alt_L                               SPACE                               Alt_R    FN       Ct_R     Left     Down     Right
    ...
    [1] = LAYOUT(
        _______,   KC_MYCM, KC_WHOM, KC_CALC, KC_MSEL, KC_MPRV, KC_MNXT, KC_MPLY, KC_MSTP, KC_MUTE, KC_VOLD, KC_VOLU, _______, _______,          KC_INSERT,
        LED_TILDE, LED_1,   LED_2,   LED_3,   LED_4,   LED_5,   LED_6,   LED_7,   LED_8,   LED_9,   LED_0,  LED_MINS, LED_EQL, _______,          _______,
        _______,   _______, RGB_VAI, _______, RGB_TOG, _______, _______, _______, _______, _______, _______, _______, _______, RESET,            _______,
        _______,   _______, RGB_VAD, _______, _______, _______, _______, _______, _______, _______, _______, _______,          _______,          _______,
        _______,            RGB_HUD, RGB_HUI, _______, VLK_TOG, _______, NK_TOGG, _______, _______, _______, _______,          _______, RGB_MOD,  KC_END,
        _______,   _______, _______,                            _______,                            _______, _______, MO(2),   RGB_SPD, RGB_RMOD, RGB_SPI
    ),
...
/*  From the sticksandgum keymap file
    [2] = LAYOUT(
...
bool encoder_update_user(uint8_t index, bool clockwise) {
  ...
  if (get_mods() & MOD_MASK_CTRL) { // If CTRL is held
    ...
    unregister_mods(MOD_MASK_SHIFT); // Immediately unregister the SHFT key - del_mods doesn't work here (not immediate)
    if (clockwise) {
    ...
    set_mods(mod_state);  // Add back in the SHFT key - so shft-key will work if shft was never released after paging.
    ...
    set_mods(mod_state); //Add back in the ALT key
